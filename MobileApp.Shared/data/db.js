...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(MobileApp.config.endpoints);

    var serviceConfig = $.extend(true, {}, MobileApp.config.services, {
        db: {
    ...
    MobileApp.db = new DevExpress.data.ODataContext(serviceConfig.db);
